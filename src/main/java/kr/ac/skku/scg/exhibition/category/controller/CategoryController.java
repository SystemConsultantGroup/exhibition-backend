...
public class CategoryController {
    ...
    public ResponseEntity<List<CategoryTreeNode>> getTree(@PathVariable UUID exhibitionId) {
        return ResponseEntity.ok(categoryService.buildTreeResponse(exhibitionId));
    }
}
