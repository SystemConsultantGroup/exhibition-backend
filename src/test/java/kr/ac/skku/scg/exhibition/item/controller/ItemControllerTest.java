        ...
        mockMvc.perform(get("/items/{id}", id))
                ...
                .andDo(document("items-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("participantNames").description("참여자명").optional(),
                                fieldWithPath("advisorNames").description("지도교수명").optional(),
        ...
        mockMvc.perform(get("/items").param("exhibitionId", exhibitionId.toString()))
                ...
                .andDo(document("items-list",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("items[].participantNames").description("참여자명").optional(),
                                fieldWithPath("items[].advisorNames").description("지도교수명").optional(),
